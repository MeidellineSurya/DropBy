...
const styles = StyleSheet.create({
  ...
  eyebrow: { color: colors.violet, fontSize: 14, fontWeight: "800", letterSpacing: 1.8 },
  title: { color: colors.text, fontSize: 36, fontWeight: "800", letterSpacing: -0.7, lineHeight: 43, marginTop: 8 },
  subtitle: { color: colors.muted, fontSize: 17, fontWeight: "500", lineHeight: 25, marginBottom: 18, marginTop: 10 },
  ...
  input: { backgroundColor: colors.background, borderColor: colors.border, borderRadius: 12, borderWidth: 1, color: colors.text, fontSize: 17, fontWeight: "500", marginBottom: 10, paddingHorizontal: 14, paddingVertical: 13 },
  error: { color: colors.danger, fontSize: 15, fontWeight: "600", lineHeight: 21, marginBottom: 10 },
  ...
  connection: { color: colors.muted, fontSize: 14, fontWeight: "500", lineHeight: 20, marginTop: 18, textAlign: "center" },
});
