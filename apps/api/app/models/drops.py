...
class Drop(Base):
    ...
    rarity: Mapped[DropRarity] = mapped_column(Enum(DropRarity), default=DropRarity.common)
    ...
    discovery_radius_m: Mapped[int] = mapped_column(Integer, default=settings.default_detect_radius_m)
    reveal_radius_m: Mapped[int] = mapped_column(Integer, default=settings.default_reveal_radius_m)
    discover_radius_m: Mapped[int] = mapped_column(Integer, default=settings.default_discover_radius_m)
    ...
    status: Mapped[DropStatus] = mapped_column(Enum(DropStatus), default=DropStatus.draft)
